...
GBEMG_MSG_eCaptureDataType =0x80,
GBEMG_MSG_eCaptureIndxVersionChanged=0x81,

GBEMG_MSG_eActType = 0x8000,
GBEMG_MSG_eActReset = 0x8000,

GBEMG_MSG_eActArrial=0x8001,
GBEMG_MSG_eActTerminal=0x8002,
