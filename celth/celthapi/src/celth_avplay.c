...
static    NEXUS_StcChannelHandle stcChannel=NULL;
static    NEXUS_PidChannelHandle videoPidChannel=NULL;
static    NEXUS_PidChannelHandle audioPidChannel=NULL;
static    NEXUS_DisplayHandle display=NULL;
static    NEXUS_VideoWindowHandle window=NULL;
static    NEXUS_VideoDecoderHandle vdecode=NULL;
static	NEXUS_AudioDecoderHandle compressedDecoder=NULL;
static	NEXUS_AudioDecoderHandle pcmDecoder=NULL;
static	NEXUS_ParserBand vparserBand=0xFF;
